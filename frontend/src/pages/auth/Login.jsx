...
//       } else {
//         alert("Dev user missing or invalid credentials. Run init_db.py first.");
//       }
//     } catch (err) {
//       console.error(err);
...
//     e.preventDefault();
//     await handleDevLogin(); // call dev login
//   };
...
//           darkMode
//             ? "bg-[linear-gradient(to_right,#262627,#4f4e4f,#262526)]"
//             : "bg-[linear-gradient(to_right,#d1d5db,#e4e4e7,#e4e4e7)]"
//         }`}
...
//               className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-300 transition-colors duration-300"
//             >
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await handleDevLogin(); // properly await the async call
  };
